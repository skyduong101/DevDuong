...
const SummaryOfCostsRemodel = (props) => {
    const [
        {
            buildingFloors,
    ...
    const calculate = () => {
        ...
        */
        ...
        const demolition =
            interiorDemolition * buildingGrossSqFt +
            slabDemolition * buildingFootprintArea * 0.25 +
            exteriorDemolition * buildingExteriorEnclosureSqFt +
            roofDemolition * buildingFootprintArea;

        const substructure = sogPatching * buildingFootprintArea * 0.25 + sogPrep * buildingGrossSqFt;

        const superstructure = entryCanopySteel * canopySqFt + miscellaneousSteel * buildingGrossSqFt;
...
export default SummaryOfCostsRemodel;
